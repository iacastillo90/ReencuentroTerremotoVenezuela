...
- IA: Anthropic API (Anthropic) para normalización y scoring
...
- [ ] Integrar Anthropic API para calcular `urgencyScore`
...
- [ ] Worker de IA: Anthropic extrae datos estructurados de mensajes en lenguaje natural
...
- **IA:** Anthropic API (`Anthropic-sonnet-4-6`) para normalización y urgencyScore. Optimizar uso de tokens con la estrategia descrita en §10.
