...
/**
 * Landing público (mockup "home public"). Pantalla de bienvenida para
 * usuarios no autenticados. Responsive: móvil (hero a pantalla completa)
 * y desktop (contenido centrado).
 */
    ...
    <div className="pl__inner">
      ...
      <div className="pl__hero">
        ...
        <div className="pl__actions">
          <button className="pl-btn primary" onClick={onBuscar}>
            <Search size={18} /> Buscar persona
          </button>
          <button className="pl-btn ghost" onClick={onAyuda}>
            <HeartHandshake size={18} /> Necesito ayuda
          </button>
        </div>
