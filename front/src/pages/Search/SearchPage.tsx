...
const MOCK_RESULTS: Record<AgeCat, Person[]> = {
  adulto: [
    { idHash: 'm-1', type: 'person', name: 'Juan Pérez', status: 'missing', age: 35, gender: 'M', lastSeen: { date: new Date().toISOString(), state: 'Distrito Capital', municipality: 'Chacao', description: 'Chacao, Caracas' }, metadata: { urgencyScore: 3, createdAt: new Date().toISOString() }, data: { origen: 'Protección Civil' } },
    { idHash: 'm-2', type: 'person', name: 'María Gonzalez', status: 'missing', age: 42, gender: 'F', lastSeen: { date: new Date().toISOString(), state: 'La Guaira', municipality: 'Macuto', description: 'Macuto, La Guaira' }, metadata: { urgencyScore: 4, createdAt: new Date().toISOString() }, data: { origen: 'Cruz Roja Venezolana' } },
    { idHash: 'm-3', type: 'person', name: 'Carlos Mendoza', status: 'found', age: 28, gender: 'M', lastSeen: { date: new Date().toISOString(), state: 'Distrito Capital', municipality: 'Catia', description: 'Catia, Caracas' }, metadata: { urgencyScore: 1, createdAt: new Date().toISOString() }, data: { origen: 'Hospital Pérez Carreño' } },
    { idHash: 'm-4', type: 'person', name: 'Ana Silva', status: 'missing', age: 50, gender: 'F', lastSeen: { date: new Date().toISOString(), state: 'La Guaira', municipality: 'Maiquetía', description: 'Maiquetía, La Guaira' }, metadata: { urgencyScore: 2, createdAt: new Date().toISOString() }, data: { origen: 'Vecinos de la zona' } }
  ] as Person[],
  adulto_mayor: [
    { idHash: 'am-1', type: 'person', name: 'Pedro Suárez', status: 'missing', age: 72, gender: 'M', lastSeen: { date: new Date().toISOString(), state: 'Distrito Capital', municipality: 'Los Palos Grandes', description: 'Los Palos Grandes, Caracas' }, metadata: { urgencyScore: 5, createdAt: new Date().toISOString() }, data: { origen: 'Familiar' } },
    { idHash: 'am-2', type: 'person', name: 'Carmen Rojas', status: 'found', age: 68, gender: 'F', lastSeen: { date: new Date().toISOString(), state: 'La Guaira', municipality: 'Caraballeda', description: 'Caraballeda, La Guaira' }, metadata: { urgencyScore: 1, createdAt: new Date().toISOString() }, data: { origen: 'Cruz Roja Venezolana' } },
    { idHash: 'am-3', type: 'person', name: 'José Martínez', status: 'missing', age: 80, gender: 'M', lastSeen: { date: new Date().toISOString(), state: 'Distrito Capital', municipality: 'Petare', description: 'Petare, Caracas' }, metadata: { urgencyScore: 5, createdAt: new Date().toISOString() }, data: { origen: 'Protección Civil' } },
    { idHash: 'am-4', type: 'person', name: 'Teresa Blanco', status: 'missing', age: 75, gender: 'F', lastSeen: { date: new Date().toISOString(), state: 'La Guaira', municipality: 'Catia La Mar', description: 'Catia La Mar, La Guaira' }, metadata: { urgencyScore: 4, createdAt: new Date().toISOString() }, data: { origen: 'Bomberos del Distrito Capital' } }
  ] as Person[],
  mascota: [
    { idHash: 'p-1', type: 'animal', name: 'Luna', status: 'missing', description: 'Poodle blanco, collar rojo', lastSeen: { date: new Date().toISOString(), state: 'Distrito Capital', municipality: 'Altamira', description: 'Altamira, Caracas' }, metadata: { urgencyScore: 2, createdAt: new Date().toISOString() }, data: { origen: 'Familiar' } },
    { idHash: 'p-2', type: 'animal', name: 'Max', status: 'found', description: 'Golden Retriever', lastSeen: { date: new Date().toISOString(), state: 'La Guaira', municipality: 'Macuto', description: 'Macuto, La Guaira' }, metadata: { urgencyScore: 1, createdAt: new Date().toISOString() }, data: { origen: 'Bienestar Animal' } },
    { idHash: 'p-3', type: 'animal', name: 'Milo', status: 'missing', description: 'Gato siamés', lastSeen: { date: new Date().toISOString(), state: 'Distrito Capital', municipality: 'El Hatillo', description: 'El Hatillo, Caracas' }, metadata: { urgencyScore: 3, createdAt: new Date().toISOString() }, data: { origen: 'Protección Civil' } },
    { idHash: 'p-4', type: 'animal', name: 'Bella', status: 'missing', description: 'Mestiza pequeña, mancha en el ojo', lastSeen: { date: new Date().toISOString(), state: 'La Guaira', municipality: 'Caraballeda', description: 'Caraballeda, La Guaira' }, metadata: { urgencyScore: 2, createdAt: new Date().toISOString() }, data: { origen: 'Rescatistas Voluntarios' } }
  ] as Person[],
  nino: [
    ...
    { idHash: 'n-3', type: 'person', name: 'Caso Protegido', status: 'missing', age: 15, gender: 'F', lastSeen: { date: new Date().toISOString(), state: 'Distrito Capital', municipality: 'Chacao', description: 'Información reservada (LOPNNA)' }, metadata: { urgencyScore: 4, createdAt: new Date().toISOString() }, data: { origen: 'Familiar' } },
